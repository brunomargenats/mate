...
if ( ! function_exists( 'mate_ie_support' ) ) {
	...
	function mate_ie_support() {
			wp_register_script( 'mate_ponyfill', get_theme_file_uri('/assets/js/css-vars-ponyfill.min.js'), array(), wp_get_theme( 'mate' )->get( 'Version' ), false );
	...
	add_action( 'get_footer', 'mate_ie_support' );
