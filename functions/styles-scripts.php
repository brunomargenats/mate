...
function mate_scripts_styles_header() {
		...
		*/
		wp_register_style('mate_variables',get_theme_file_uri( '/config/variables.min.css' ), array(), MATE_VERSION );
		wp_register_style('mate_reset',get_theme_file_uri( '/assets/css/reset.min.css' ), array(), MATE_VERSION );
		wp_register_style('mate_base',get_theme_file_uri( '/assets/css/base.min.css' ), array(), MATE_VERSION );
		wp_register_style('mate_grid',get_theme_file_uri( '/assets/css/grid.min.css' ), array(), MATE_VERSION );
		wp_register_style('mate_typography',get_theme_file_uri( '/assets/css/typography.min.css' ), array(), MATE_VERSION );
		wp_register_style('mate_print',get_theme_file_uri( '/assets/css/print.min.css' ), array(), MATE_VERSION, 'print' );
...
if ( ! function_exists( 'mate_scripts_styles_footer' ) ) {
	...
	function mate_scripts_styles_footer() {
		wp_register_style('mate_forms',get_theme_file_uri( '/assets/css/forms.min.css' ), array(), MATE_VERSION );
		wp_enqueue_style( 'mate_forms');
		wp_register_style('mate_buttons',get_theme_file_uri( '/assets/css/buttons.min.css' ), array(), MATE_VERSION );
...
if ( ! function_exists( 'mate_admin_style_blocks' ) ) {
	...
	function mate_admin_style_blocks(){
		wp_enqueue_style('mate_variables',get_theme_file_uri( '/config/variables.min.css' ),array( 'wp-edit-blocks' ), MATE_VERSION);
		wp_enqueue_style('mate_buttons',get_theme_file_uri( '/assets/css/buttons.min.css' ),array( 'wp-edit-blocks' ), MATE_VERSION);
	}
