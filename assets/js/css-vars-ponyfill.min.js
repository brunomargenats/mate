...
/* == READ BEFORE UPDATE: ==
 * If you want to update this JS, you can found new releases here: https://www.jsdelivr.com/package/npm/css-vars-ponyfill
 * Modify only the Update Zone and the version of this file (v2.2.1)
 * Don't forget to also replace css-vars-ponyfill.min.js.map.
*/
...
/* ==== DON'T DELETE THE FOLLOWING CODE OR THE FUNCTION WILL NOT START: ==== */

// ==== START IE Ponyfill ====
// Call using defaults : cssVars();
